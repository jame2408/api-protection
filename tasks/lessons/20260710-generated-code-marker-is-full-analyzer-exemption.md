...
**落地:** backend/.editorconfig 兩手寫檔標記已移除（67c802e＋63e6ee1）＋CA1310/CA1822×2 補修＋verification-matrix 19c 備註；欄位對齊排版依裁決放棄。歸檔（triage 第四輪）：規則本身已由 `scripts/source-lint.sh` `bad_generated` 段機械化（矩陣 9h，綠＋故意紅驗證），防線代記。
