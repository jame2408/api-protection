...
# appends the observation record. stdout from Python is captured; the write
# happens inside Python where data is already validated JSON.
#
...
OBS_FILE="$OBS_FILE" python3 -c "$PY" <<<"$INPUT"
